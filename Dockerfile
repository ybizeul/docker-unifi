...
RUN apt-get -q update && apt-get install -qy --force-yes https://www.ubnt.com/downloads/unifi/5.3.11/unifi_sysvinit_all.deb && apt-get -q clean && rm -rf /var/lib/apt/lists/*
